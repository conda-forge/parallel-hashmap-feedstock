...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/parallel-hashmap-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10624&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/parallel-hashmap-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `parallel-hashmap` can be installed with:

```
conda install parallel-hashmap
```

It is possible to list all of the versions of `parallel-hashmap` available on your platform with:
